      ...
      <DialogContent className="max-w-fit">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-2 items-center gap-4">
            ...
            <Input onChange={nameChangeHandler} id="name" placeholder="Type food name"  className="col-span-3" />
          </div>
          <div className="grid grid-cols-2 items-center gap-4">
            <Label htmlFor="username" >
              Food price
            </Label>
            <Input onChange={priceChangeHandler} id="username" placeholder="Enter price..."  className="col-span-3" />
          </div>
          </div>
          <div className=" items-center gap-4 ">
            ...
            <Input onChange={ingredientsChangeHandler} id="username" placeholder="List ingredients..."  className="pb-[60px] pt-[20px]" />
          </div>
          <div className=" items-center gap-4">
        ...
        <DialogFooter>
          <DialogClose asChild>
          <Button onClick={addFoods} type="submit">Add Dish</Button>
          </DialogClose>
        </DialogFooter>
      </DialogContent>
    </Dialog>
